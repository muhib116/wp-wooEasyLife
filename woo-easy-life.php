 ...
 * Description: "Woo Easy Life" is a custom plugin designed to enhance WooCommerce functionality with features like bulk SMS, fraud detection, OTP validation, cache prevention, and much more.
 * Version: 1.1.8
