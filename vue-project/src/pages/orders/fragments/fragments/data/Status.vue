<template>
    <button class="relative order-status capitalize px-3 text-[13px] rounded-[18px] pointer-events-auto" :class="`status-${order.status}`">
        ...
        <span 
            ...
            class="cursor-pointer absolute -top-2 right-0 size-4 bg-red-500 aspect-square border-none text-white rounded-full text-[10px] hover:scale-110 shadow duration-300"
